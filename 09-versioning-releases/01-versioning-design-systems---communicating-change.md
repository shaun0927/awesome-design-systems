...
# Versioning Design Systems - Communicating Change
...
<CrossRef related={[
  { path: "/09-versioning-releases/02-releasing-design-systems---outputs-cadence-versions", label: "09-02. 릴리스 전략 - 출력물, 주기, 버전" },
  { path: "/09-versioning-releases/03-visual-breaking-change---color-typography-space", label: "09-03. Visual Breaking Change" },
