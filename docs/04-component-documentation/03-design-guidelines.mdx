...
- [WAI-ARIA Authoring Practices Guide (APG)](https://www.w3.org/WAI/ARIA/apg/) — 접근성 가이드라인의 공식 패턴 레퍼런스
- [Inclusive Components by Heydon Pickering](https://inclusive-components.design/) — 접근 가능한 컴포넌트 패턴 모음
- [GOV.UK Design System](https://design-system.service.gov.uk/) — 사용자 중심 가이드라인 작성의 모범 사례
- [Button Design Best Practices (Smashing Magazine)](https://www.smashingmagazine.com/2016/11/a-quick-guide-for-designing-better-buttons/) — 버튼 디자인 가이드라인 패턴
- [Material Design Behavior Guidelines](https://m3.material.io/foundations/interaction/states) — Behavior 섹션 작성의 참고 사례

### 이론적 배경
- **Information Architecture**: 가이드라인은 "빠른 검색"을 위한 레퍼런스 구조여야 함 (Rosenfeld & Morville)
- **Progressive Disclosure**: Use When/Visual/Behavior/Editorial/Accessibility 순서는 인지 부하 최소화 원칙

### 실제 사례
- **Atlassian Design System**: 각 섹션을 탭으로 분리하여 정보 과부하 방지
- **Shopify Polaris**: Editorial 섹션에 카피 라이팅 템플릿 제공 ("Save changes" vs "OK")
- **Carbon Design System (IBM)**: Accessibility 섹션에 스크린리더 읽기 순서 명시
