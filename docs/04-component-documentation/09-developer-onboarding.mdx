...
sidebar_position: 9
tags: [onboarding, developers, getting-started, installation]
---
...
<CrossRef
  related={[
    ...
    { path: "/docs/component-documentation/documentation-guidelines", label: "Component Documentation Guidelines" },
