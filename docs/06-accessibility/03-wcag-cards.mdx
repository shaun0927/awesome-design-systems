...
- [WCAG 2.2 Quick Reference](https://www.w3.org/WAI/WCAG22/quickref/) — 필터링 가능한 공식 기준 레퍼런스
- [WCAG in Language I Can Understand (Martin Underhill)](https://www.wcaginlanguageican.com/) — 카드 설명의 원본 소스
- [IBM Accessibility Checker](https://www.ibm.com/able/toolkit/verify/automated/) — Decision Tree 기반 접근성 검증 도구
- [axe DevTools Browser Extension](https://www.deque.com/axe/devtools/) — 브라우저에서 실시간 접근성 검사
- [WebAIM Contrast Checker](https://webaim.org/resources/contrastchecker/) — 색상 대비 계산기 (4.5:1 AA / 7:1 AAA)

### 이론적 배경
- **POUR Framework**: Perceivable, Operable, Understandable, Robust — WCAG의 철학적 기반
- **A/AA/AAA Levels**: Level A (최소), AA (권장), AAA (최적) — 대부분의 조직은 AA 준수 목표
- **Making Accessibility More Accessible**: 전문 용어를 제거하여 비전문가도 이해 가능하게 (Johannes Ippen)

### 실제 사례
- **Gov.uk**: WCAG 카드 덱을 팀 온보딩에 사용하여 3개월 교육 → 2주로 단축
- **Spotify**: 테마별 카드 그룹핑으로 접근성 감사 시간을 60% 단축
- **Automattic (WordPress)**: 카드 덱을 다국어로 번역하여 글로벌 기여자 교육에 활용
