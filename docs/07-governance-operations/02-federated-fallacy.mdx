...
### 핵심 문헌
- [Nathan Curtis - "The Fallacy of the Federated Design System"](https://medium.com/eightshapes-llc/the-fallacy-of-the-federated-design-system-5219b5c8c5b) — 연합형 모델의 6가지 신화 원문
- [Nathan Curtis - "Team Models for Design Systems"](https://medium.com/eightshapes-llc/team-models-for-scaling-a-design-system-2cf9d03be6a0) — 중앙형 vs 연합형 팀 모델 비교
- [InnerSource Commons](https://innersourcecommons.org/) — 기업 내부의 오픈소스 협업 패턴 (연합형 기여 모델의 성공 사례)

### 팀 구조 이론
- Matthew Skelton & Manuel Pais, [Team Topologies](https://teamtopologies.com/) (2019) — **Platform Team** vs **Stream-aligned Team** 구분
- Jared Spool, ["The Unicorn Myth"](https://articles.uie.com/unicorn/) — 단일 팀원이 모든 역량을 가질 수 없다는 현실
- Charity Majors, ["The Engineer/Manager Pendulum"](https://charity.wtf/2017/05/11/the-engineer-manager-pendulum/) — 전문화된 역할의 필요성

### 실제 사례
- [Atlassian Atlaskit](https://atlassian.design/components) — 핵심은 중앙 팀, Editor는 커뮤니티 주도 (하이브리드 모델)
- [GitHub Primer](https://primer.style/) — 중앙 팀 + 엄격한 기여 가이드
- [Spotify Design System](https://spotify.design/) — Guild 모델 (크로스 팀 협업 채널)
- [Uber Base Web](https://baseweb.design/) — 중앙 팀 소유, 제한적 외부 기여

### 기여 모델 참고
- [Open Source Guides - "Best Practices for Maintainers"](https://opensource.guide/best-practices/) — CONTRIBUTING.md 작성 모범 사례
- [Mozilla's Participation Guidelines](https://www.mozilla.org/en-US/about/governance/policies/participation/) — 커뮤니티 행동 강령 예시
- [React Contributing Guide](https://legacy.reactjs.org/docs/how-to-contribute.html) — RFC 프로세스 참고
...
<CrossRef related={[
  ...
  { path: "/docs/governance-operations/support-workflow", label: "07-03. 지원 워크플로우" },
