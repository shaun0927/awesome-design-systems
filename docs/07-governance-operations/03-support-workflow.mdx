...
### 핵심 문헌
- Nathan Curtis, "Design System Support" (EightShapes) — 지원 워크플로우 설계 원칙
- [GitHub Issue Templates Documentation](https://docs.github.com/en/communities/using-templates-to-encourage-useful-issues-and-pull-requests) — 공식 템플릿 작성 가이드
- [Atlassian Service Management](https://www.atlassian.com/software/jira/service-management) — SLA 및 티켓 관리 모범 사례

### SLA & 지원 프로세스
- Google SRE Book, ["Service Level Objectives"](https://sre.google/sre-book/service-level-objectives/) — SLA 설정 원칙
- Zendesk, ["Customer Support Response Time Standards"](https://www.zendesk.com/blog/customer-service-response-time/) — 업계 표준 응답 시간
- ITIL v4 Framework — IT 서비스 관리 표준 (Incident, Request 분류)

### 커뮤니티 관리
- Jono Bacon, ["The Art of Community"](https://www.jonobacon.com/books/artofcommunity/) (2009) — 오픈소스 커뮤니티 운영 원칙
- [Django Contribution Guide](https://docs.djangoproject.com/en/dev/internals/contributing/) — 이슈 트리아지 프로세스 예시
- [Rust Community Guidelines](https://www.rust-lang.org/policies/code-of-conduct) — 커뮤니티 행동 강령

### 실제 사례
- [Material Design Issue Tracker](https://github.com/material-components/material-web/issues) — Google의 이슈 템플릿 및 라벨 시스템
- [Shopify Polaris Support](https://github.com/Shopify/polaris/blob/main/.github/ISSUE_TEMPLATE/BUG_REPORT.yml) — YAML 기반 이슈 템플릿
- [Carbon Design System Support](https://github.com/carbon-design-system/carbon/blob/main/.github/SUPPORT.md) — 지원 채널 구조
...
<CrossRef related={[
  ...
  { path: "/docs/governance-operations/federated-fallacy", label: "07-02. 연합형의 오류" },
  { path: "/docs/governance-operations/subtask-decomposition", label: "07-04. 서브태스크 분해 방법론" },
]} />
