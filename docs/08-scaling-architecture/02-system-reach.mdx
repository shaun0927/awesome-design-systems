...
### 핵심 문헌
- [Nathan Curtis - A Design System's Reach](https://medium.com/eightshapes-llc/a-design-systems-reach-3fb61e0d9448) — 디자인 시스템의 4단계 범위 모델 (Team/Portfolio/Enterprise/Worldwide)
- [Brad Frost - Atomic Design](https://atomicdesign.bradfrost.com/) — 컴포넌트 기반 시스템 설계 방법론

### 실제 사례
- [IBM Carbon Design System](https://carbondesignsystem.com/) — Enterprise 수준의 멀티 플랫폼 시스템 (React, Vue, Angular, Web Components)
- [Atlassian Design System](https://atlassian.design/) — Portfolio에서 Enterprise로 확장한 사례
- [Material Design](https://m3.material.io/) — Worldwide 수준의 오픈소스 디자인 언어

> **실제 사례**: Shopify Polaris는 Portfolio 수준으로 시작했으나 2018년 오픈소스화하며 Worldwide로 확장. 초기 3명 팀에서 현재 15명 이상의 전담 조직으로 성장했습니다.
