...
### 핵심 문헌
- [Nathan Curtis - Adopting Generations](https://medium.com/eightshapes-llc/adopting-design-system-generations-f2d5c3d23cc7) — 점진적 전달과 4가지 채택자 유형 대응 전략
- [jscodeshift Documentation](https://github.com/facebook/jscodeshift) — React 코드베이스 자동 변환 도구

### 실제 사례
- [Atlassian Design System Migration](https://atlassian.design/) — Codemod 기반 자동 마이그레이션 도구 제공
- [Shopify Polaris v12 Migration](https://polaris.shopify.com/) — Adapter 패턴으로 v11/v12 병행 운영

> **실제 사례**: Atlassian은 `@atlaskit/codemod-cli`를 제공하여 개발자가 한 줄 명령어로 수백 개 파일을 자동 마이그레이션할 수 있습니다. 마이그레이션 진행률 대시보드도 함께 제공합니다.
