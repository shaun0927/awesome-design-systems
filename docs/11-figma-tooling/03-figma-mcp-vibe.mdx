...
### 핵심 문헌
- [Figma MCP Server Documentation](https://github.com/anthropics/mcp-figma) — Model Context Protocol 공식 문서
- [Cursor AI Documentation](https://cursor.sh/docs) — AI 코딩 도구, Figma MCP 통합 가이드
- [shadcn/ui Components](https://ui.shadcn.com/) — Figma Make 기본 컴포넌트 라이브러리

### 실제 사례
- [Carbon Design System](https://carbondesignsystem.com/) — IBM의 디자인 시스템, Figma Make Export 지원
- [Material Design 3](https://m3.material.io/) — Google의 디자인 시스템, Figma Variables 활용

> **실제 사례**: 한 팀은 Figma MCP를 Cursor에 연결하여 신규 프로젝트에서 50-70% 완성도의 코드를 즉시 생성했습니다. 명명된 레이어와 Auto Layout이 핵심이었습니다.
