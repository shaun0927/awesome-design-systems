...
### 핵심 문헌
- [Figma Plugin API](https://www.figma.com/plugin-docs/) — 리서치 자동화 플러그인 개발 가이드
- [GitHub Copilot Documentation](https://docs.github.com/en/copilot) — 프롬프트 최적화 도구
- [GM Design System](https://designsystem.gm.com/) — General Motors 브랜드 가이드라인

### 실제 사례
- [Figma Auto Layout Guide](https://help.figma.com/hc/en-us/articles/auto-layout) — Auto Layout으로 반응형 프로토타입 생성
- [Slack API Integration](https://api.slack.com/) — 비동기 커뮤니케이션 워크플로우

> **실제 사례**: GM의 UX 리서처는 Figma Make로 네비게이션 가이드를 스캔 가능한 3컬럼 비주얼로 변환하여 복잡한 표 데이터를 5초 안에 이해할 수 있게 만들었습니다.
